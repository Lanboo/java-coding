...
public class KafkaConsumerDemo implements Runnable {
    ...
    private void init(String topic) {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, this.getClass().getSimpleName() + 1);
    ...
    public void run() {
        ...
        while(true) {
            ...
            for(ConsumerRecord<Integer, String> cRecord : consumerRecords) {
                System.out.println("message receive:value=" + cRecord.value() + ",offset=" + cRecord.offset());
